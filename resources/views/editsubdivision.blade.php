...
<form action="{{ route('update_subdivision', $subdivision->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-4">
        ...
        <input type="text" name="location" class="w-full border rounded py-2 px-3" value="{{ $subdivision->location }}" required>
      </div>

    <div class="mb-4">
        <label class="text-gray-700 font-bold mb-2">Description</label>
        <input type="text" name="description" class="w-full border rounded py-2 px-3" value="{{ $subdivision->description }}" required>
    </div>
